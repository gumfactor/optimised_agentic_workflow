...
echo "2) Install local git hooks: bash scripts/install-hooks.sh"
echo "3) Validate mandatory compliance locally: bash scripts/policy-lint.sh"
echo "4) Validate hygiene script (optional): bash scripts/proactive-hygiene.sh"
echo "5) Commit the imported kit files."
